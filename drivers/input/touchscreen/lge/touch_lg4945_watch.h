...
extern int watch_register_sysfs(struct device *dev);
...
extern int ext_watch_check_font_download(struct device *dev);
void ext_watch_font_download_func(struct work_struct *font_download_work);
extern void watch_remove(struct device *dev);
extern int watch_init(struct device *dev);
