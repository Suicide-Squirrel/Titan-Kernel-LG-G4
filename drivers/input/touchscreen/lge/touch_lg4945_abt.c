...
/*****************************************************************************/
void sic_abt_probe(void)
{
	mutex_init(&abt_comm_lock);
}

void sic_abt_remove(void)
{
...
void sic_abt_init(struct device *dev)
{
...
int sic_abt_is_debug_mode(void)
{
...
void sic_abt_ocd_off(struct device *dev)
{
	u32 wdata = 0;
...
void sic_abt_onchip_debug(struct device *dev, u8 *all_data)
{
	u32 i;
	u32 wdata;
	u16 addr;
...
void sic_abt_report_mode(struct device *dev, u8 *all_data)
{
...
void sic_abt_register_sysfs(struct kobject *kobj)
{
...
void sic_abt_remove(void) {}
void sic_abt_init(struct device *dev) {}
int sic_abt_is_debug_mode(void) { return 0; }
void sic_abt_ocd_off(struct device *dev) {}
void sic_abt_onchip_debug(struct device *dev, u8 *all_data) {}
void sic_abt_report_mode(struct device *dev, u8 *all_data) {}
void sic_abt_register_sysfs(struct kobject *kobj) {}
