...
extern void sic_abt_probe(void);
extern void sic_abt_remove(void);
extern void sic_abt_init(struct device *dev);
extern int sic_abt_is_debug_mode(void);
extern void sic_abt_ocd_off(struct device *dev);
extern void sic_abt_onchip_debug(struct device *dev, u8 *all_data);
extern void sic_abt_report_mode(struct device *dev, u8 *all_data);
extern void sic_abt_register_sysfs(struct kobject *kobj);
#endif
